...
class LinkedList:
    ...
    def sort_by_exchange(self):
        """Ordenación por intercambio (burbuja) en la lista enlazada"""
...
class LinkedListApp:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Lista Enlazada - Ordenación por Intercambio")
    ...
    def sort_list(self):
        """Ordenar la lista por intercambio y mostrar el resultado con el tiempo de ejecución"""
        ...
        self.result_text.delete(1.0, tk.END)
        self.result_text.insert(tk.END, f"Lista ordenada por intercambio:\n{self.linked_list.display()}\n")
