...
class LinkedList:
    ...
    def sort_by_selection(self):
        """Ordenación por selección en la lista enlazada"""
        current = self.head
        while current:
            min_node = current
            ...
            # Intercambiar los valores de 'current' y 'min_node'
...
class LinkedListApp:
    def __init__(self, root):
        ...
        self.root = root
        self.root.title("Lista Enlazada - Ordenación por Selección")
        ...
        self.sort_button = tk.Button(root, text="Ordenar Lista por Selección", command=self.selection_sort)
    ...
    def selection_sort(self):
        """Ordenar la lista por selección y mostrar el resultado y el tiempo"""
        ...
        self.result_text.delete(1.0, tk.END)
        self.result_text.insert(tk.END, f"Lista ordenada por selección:\n{self.linked_list.display()}\n")
